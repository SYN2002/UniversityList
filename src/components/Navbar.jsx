    ...
    return (
        <div className='fixed top-0 left-0 z-20 w-full bg-gradient-to-r from-[#3d71c4] to-[#20bbd6]'>
            <div className='mx-5 flex p-3 justify-between'>
                <div><a href="https://private-share.vercel.app/"><p className='text-white font-bold text-4xl max-[640px]:text-3xl font-Montserrat'>University List Generator</p></a></div>
